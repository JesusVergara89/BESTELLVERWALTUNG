...
"""
import os
from django.contrib.messages import constants as errormsj 
...
SECRET_KEY = 'django-insecure-*c!o&)bgg*&sphp008v2yz(^i8lqhq^eg@5i)9@6pql3eu^qm-'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'basket.context_processor.total_basket',
            ],
        },
    },
]
